...
"""Create a lightweight, structured summary suitable for LLM input."""
providers = []
if "provider" in data:
...
# pick a few interesting fields commonly present
item = {"type": rtype, "name": name}
if isinstance(cfg, dict):
for k in ["cidr_block", "vpc_id", "subnet_id", "engine", "instance_class", "allocated_storage", "port", "ingress", "egress", "ami", "instance_type"]:
if k in cfg:
item[k] = cfg[k]
